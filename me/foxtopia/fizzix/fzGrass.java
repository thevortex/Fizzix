...
public class fzGrass extends Block{
	    ...
	    {
	        return par1 == 1 ? this.iconGrassTop : (par1 == 0 ? Fizzix.Dirt.getBlockTextureFromSide(par1) : this.blockIcon);
	    }
	    ...
	    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
	    {
	        if (!par1World.isRemote)
	        {
	            ...
	            {
	                par1World.setBlock(par2, par3, par4, Fizzix.Dirt.blockID);
	            }
	            else if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
	            {
	                for (int l = 0; l < 4; ++l)
	                {
	                    ...
	                    if (par1World.getBlockId(i1, j1, k1) == Fizzix.Dirt.blockID && par1World.getBlockLightValue(i1, j1 + 1, k1) >= 4 && par1World.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
	                    {
	                        par1World.setBlock(i1, j1, k1, Fizzix.Grass.blockID);
	                    }
	                }
	            }
	        }
	    ...
	    {
	        return Fizzix.Grass.getBlockTextureFromSide(2);
	    }
